...
好了亲爱的观众们我知道你们又要抱怨你们的Vim/Emacs设置了代码自动缩进粘贴Python很麻烦……（你说你用Sublime Text或者Notepad++？好吧自便。你说你用记事本？这我就不能忍了，哪凉快哪呆着去！→\_→）我就大发慈悲把源文件传上来吧，右键点击[这里](./hrit.py)另存为即可。然后拷贝到你的PATH中任意一个目录。
